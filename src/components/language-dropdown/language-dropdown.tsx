...
function LanguagesDropdown () {
  ...
  const onClickSuggestedLanguage = (language: {
    name: string
    index: number
  }) => {
    ...
    hideSuggestions()
    setFilteredLanguages(languages)
    importLanguage(languageIndex).then((languageData) => {
      console.log(
        '🚀 ~ file: language-dropdown.tsx ~ line 55 ~ LanguagesDropdown ~ languageData',
        languageData
      )
  ...
  return (
    <div>
      <div onClick={showSuggestions} className={styles?.autosuggest__container}>
